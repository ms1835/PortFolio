    ...
    <footer className="bg-gray-800 text-white py-10">
      <div className="container mx-auto flex flex-wrap justify-between">
        ...
        <div className="w-full md:w-1/3 m-6 mb-6 md:mb-0">
          ...
          <ul className="space-y-2 m-6">
            <li>
              <img className='inline h-4 w-4 mr-2' src="https://upload.wikimedia.org/wikipedia/commons/thumb/c/ce/X_logo_2023.svg/120px-X_logo_2023.svg.png" ></img>
              <a href="https://twitter.com/" target="_blank" rel="noopener noreferrer" className="hover:text-gray-400">Twitter</a>
            </li>
            <li>
              <img className='inline h-4 w-4 mr-2' src="https://raw.githubusercontent.com/rahuldkjain/github-profile-readme-generator/master/src/images/icons/Social/linked-in-alt.svg"></img>
            ...
            <li>
              <img className='inline h-4 w-4 mr-2' src="https://github.githubassets.com/images/modules/logos_page/GitHub-Mark.png"></img>
              <a href="https://github.com/ms1835" target="_blank" rel="noopener noreferrer" className="hover:text-gray-400">GitHub</a>
            </li>
            <li>
              <img className='inline h-4 w-4 mr-2' src="https://upload.wikimedia.org/wikipedia/commons/thumb/9/95/Instagram_logo_2022.svg/150px-Instagram_logo_2022.svg.png"></img>
